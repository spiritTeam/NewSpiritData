$(function(){
	...
	$(".usename").blur(function(){
		...
		if( $(".usename").val()=="")
		{ 
			$(".usename").parent().addClass("errorC");
			$(".error4").html("请输入用户名");
			$(".error4").css("display","block");
		}
		else if($(".usename").val().length<11)
        {   
        	$(".usename").parent().addClass("errorC");
            $(".error4").html("用户名长度有误！");
            $(".error4").css("display","block");
        ...
        {
        	$(".usename").parent().addClass("checkedN");
        }
	});
	...
	$(".usename").focus(function(){
		$(".usename").parent().removeClass("errorC");
		$(".usename").parent().removeClass("checkedN");
		$(".error4").hide();
